...
if(tt==41){
  save(mmphe,vvphe,lanbymod,quant,nlpix,file=paste('landsat_c5_2013_sos_',scene,'.RData',sep=''))
}else if(tt==40){
  save(mmphe,vvphe,lanbymod,quant,nlpix,file=paste('landsat_c5_2012_sos_',scene,'.RData',sep=''))
}else if(tt==73){
  save(mmphe,vvphe,lanbymod,quant,nlpix,file=paste('landsat_c5_2013_eos_',scene,'.RData',sep=''))
}else{
  save(mmphe,vvphe,lanbymod,quant,nlpix,file=paste('landsat_c5_2012_eos_',scene,'.RData',sep=''))
}
