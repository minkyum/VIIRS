...
arrows(mesd[,1],mesd[,2]-mesd[,5],mesd[,1],mesd[,2]+mesd[,5],
       length=0.05,angle=0)
arrows(mesd[,1]-mesd[,4],mesd[,2],mesd[,1]+mesd[,4],mesd[,2],
       length=0.05,angle=0)
abline(0,1)
abline(lm(mesd[,2]~mesd[,1]),lwd=1.3,lty=5)
points(mesd[,1],mesd[,2],bg=mycol,pch=c(rep(21,6),rep(23,5)),cex=1.7)
legend('topleft',c('Harvard','Bartlett','Cary','Hubbard','Proctor','Boundary waters'),
       bty='n',pch=21,pt.bg=mycol,pt.cex=1.5)
reg <- summary(lm(mesd[,2]~mesd[,1]))
...
rmse <- round(sqrt(mean((mesd[,2]-mesd[,1])^2)),1)
...
plot(mesd[,1],mesd[,3],
     ...
     ylab='Landsat SOS',
     cex.lab=1.1,cex.axis=1.0)
arrows(mesd[,1],mesd[,3]-mesd[,6],mesd[,1],mesd[,3]+mesd[,6],
       length=0.05,angle=0)
arrows(mesd[,1]-mesd[,4],mesd[,3],mesd[,1]+mesd[,4],mesd[,3],
       length=0.05,angle=0)
abline(0,1)
abline(lm(mesd[,3]~mesd[,1]),lwd=1.3,lty=5)
points(mesd[,1],mesd[,3],bg=mycol,pch=c(rep(21,6),rep(23,5)),cex=1.7)
# legend('topleft',c('Harvard','Bartlett','Cary','Hubbard','Proctor','Boundary waters'),
#        bty='n',pch=21,pt.bg=mycol,cex=1.2)
reg <- summary(lm(mesd[,3]~mesd[,1]))
rseq <- round(reg$r.squared,2)
b1 <- round(reg$coefficients[2],1)
b1c1 <- b1+round(reg$coefficients[4],1)
b1c2 <- b1-round(reg$coefficients[4],1)
...
b0c1 <- b0+round(reg$coefficients[3],1)
b0c2 <- b0-round(reg$coefficients[3],1)
rmse <- round(sqrt(mean((mesd[,3]-mesd[,1])^2)),1)
text(143,123,expression(paste(R^2,'=')),pos=4,cex=0.8)
text(148,123,rseq,pos=4,cex=0.8)
text(155,123,substitute(paste('(', italic(p),' < 0.01)',sep='')),pos=4,cex=0.8)
text(143,119,paste('RMSE =',rmse),pos=4,cex=0.8)
...
plot(mesd[,2],mesd[,3],
     ...
     ylab='Landsat SOS',
     cex.lab=1.1,cex.axis=1.0)
arrows(mesd[,2],mesd[,3]-mesd[,6],mesd[,2],mesd[,3]+mesd[,6],
       length=0.05,angle=0)
arrows(mesd[,2]-mesd[,5],mesd[,3],mesd[,2]+mesd[,5],mesd[,3],
       length=0.05,angle=0)
abline(0,1)
abline(lm(mesd[,3]~mesd[,2]),lwd=1.3,lty=5)
points(mesd[,2],mesd[,3],bg=mycol,pch=c(rep(21,6),rep(23,5)),cex=1.7)
# legend('topleft',c('Harvard','Bartlett','Cary','Hubbard','Proctor','Boundary waters'),
#        bty='n',pch=21,pt.bg=mycol,cex=1.2)
reg <- summary(lm(mesd[,3]~mesd[,2]))
rseq <- round(reg$r.squared,2)
b1 <- round(reg$coefficients[2],1)
b1c1 <- b1+round(reg$coefficients[4],1)
b1c2 <- b1-round(reg$coefficients[4],1)
...
b0c1 <- b0+round(reg$coefficients[3],1)
b0c2 <- b0-round(reg$coefficients[3],1)
rmse <- round(sqrt(mean((mesd[,3]-mesd[,2])^2)),1)
text(143,123,expression(paste(R^2,'=')),pos=4,cex=0.8)
text(148,123,rseq,pos=4,cex=0.8)
text(155,123,substitute(paste('(', italic(p),' < 0.01)',sep='')),pos=4,cex=0.8)
text(143,119,paste('RMSE =',rmse),pos=4,cex=0.8)
