# This code generate is for diagnostic plots for MODIS MCD12Q2 C6 version 2.
# 1. QA_overall
# 2. Num_Cycles
# 3. EVI_Amplitude
# 4. EVI_Area
...
# 9. C6 vsC5
# For the number 8 part, it is the comparision of C6 with C5
#  - 1 to 1 comparision of Phenometrics (Greenup, Maturity, Senescense, Dormancy) 
#  - Year-to-year variability (boxplot)
#  - Land pixel NA fraction (barplot)
